    ...
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        <div class="col-span-12 space-y-6 xl:col-span-7">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
                <!-- Metric Item Start -->
                <div
                    class="rounded-2xl border border-gray-200 bg-[#ffff] p-5 dark:border-gray-800 dark:bg-[#171f2f] md:p-6">
                    <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800">
                        <svg class="text-gray-800 dark:text-[var(--color-gray-25)]" width="24" height="24"
                    ...
                    <div class="mt-5 flex items-end justify-between">
                        <div>
                            ...
                            <h4 class="mt-2 text-title-sm font-bold text-gray-800 dark:text-[var(--color-gray-25)]">
                                100
                            </h4>
                        </div>

                        <span
                            class="flex items-center gap-1 rounded-full bg-success-50 py-0.5 pl-2 pr-2.5 text-sm font-medium text-success-600 dark:bg-[#1c3638] dark:text-success-500">
                ...
                <div
                    class="rounded-2xl border border-gray-200 bg-[#ffff] p-5 dark:border-gray-800 dark:bg-[#171f2f] md:p-6">
                    <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800">
                        <svg class="fill-gray-800 dark:text-[var(--color-gray-25)]" width="24" height="24"
                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div class="mt-5 flex items-end justify-between">
                        <div>
                            <span class="text-sm text-gray-500 dark:text-gray-400">Pesanan</span>
                            <h4 class="mt-2 text-title-sm font-bold text-gray-800 dark:text-[var(--color-gray-25)]">
                                5359
                            </h4>
                        </div>
            ...
            <div
                class="relative overflow-hidden rounded-2xl border border-gray-200 bg-[#ffff] px-5 pt-5 dark:border-gray-800 dark:bg-[#171f2f] sm:px-6 sm:pt-6">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-[var(--color-gray-25)]">
                        Data Penjualan
                    </h3>
                    ...
                    <div x-data="{ openDropDown: false }" class="relative h-fit">
                        ...
                        <!-- Dropdown -->
                        <div x-show="openDropDown" x-transition x-cloak @click.outside="openDropDown = false"
                            class="absolute right-0 z-50 w-40 p-2 space-y-1 bg-[#ffff] border border-gray-200 top-full rounded-2xl shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark">
                            <button
        ...
        <div class="col-span-12 xl:col-span-5">
            <div class="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="shadow-default rounded-2xl bg-[#ffff] px-5 pb-11 pt-5 dark:bg-gray-900 sm:px-6 sm:pt-6">
                    <div class="flex justify-between">
                        ...
                        <div x-data="{openDropDown: false}" class="relative h-fit">
                            ...
                            <div x-show="openDropDown" @click.outside="openDropDown = false"
                                class="absolute right-0 top-full z-40 w-40 space-y-1 rounded-2xl border border-gray-200 bg-[#ffff] p-2 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark">
                                <button
                    ...
                    <div class="relative max-h-[195px]">
                        <div id="chartTwo" class="mx-auto w-[260px] h-[260px]"></div>
                        <span
